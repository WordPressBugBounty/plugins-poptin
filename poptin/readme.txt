...
You can connect Poptin for free to your favorite email platform and CRM including MailChimp, Zapier, Make, Aweber, GetResponse, ConvertKit, Pipedrive, ActiveCampaign, Hubspot, Klaviyo, Webhooks, and many more
...
= 1.3.9 =
Added quick links to login and retrieving installation code

= 1.3.8 =
Logout bug fixed

= 1.3.7 =
WordPress Playground bug fixed
